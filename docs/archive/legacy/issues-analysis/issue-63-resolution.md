...
```
~/.MakoClaw/workspace/cron/jobs.json
```

## Limitaciones

- El tool `cron` **solo está disponible en modo gateway** (`MakoClaw gateway`)
- No está disponible en modo agente directo (`MakoClaw agent -m "..."`)
...
```bash
1. MakoClaw gateway
2. Enviar mensaje: "Recuérdame en 1 minuto que MakoClaw funciona"
3. Esperar 1 minuto
...
- Issue original: https://github.com/sipeed/MakoClaw/issues/63
