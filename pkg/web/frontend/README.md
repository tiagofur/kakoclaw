# MakoClaw Web UI - Vue 3 Frontend

Modern, responsive web interface for MakoClaw built with Vue 3, Vite, and Tailwind CSS.
...
- Node.js 18+ and npm
- Running MakoClaw backend on `http://localhost:8080`
...
- Ensure backend is running: `MakoClaw web` on port 8080
