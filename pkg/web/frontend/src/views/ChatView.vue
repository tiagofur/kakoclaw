<template>
  <div class="flex h-full bg-makoclaw-bg relative overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute inset-0 opacity-30 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-makoclaw-accent/40 via-transparent to-transparent" />
      <div class="absolute inset-0 opacity-20 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-500/30 via-transparent to-transparent" />
    </div>
    ...
    >
      <div class="p-3 sm:p-4 border-b border-makoclaw-border/30 bg-makoclaw-surface/30">
        <div class="flex justify-between items-center gap-2">
          ...
          <button
            class="p-1.5 hover:bg-makoclaw-accent/10 rounded-lg text-makoclaw-text-secondary hover:text-makoclaw-accent transition-all"
            title="New Chat"
            @click="startNewChat"
          >
            <svg
    ...
    <div class="flex-1 flex flex-col min-w-0 relative bg-makoclaw-bg/50">
      ...
      <div class="flex items-center px-3 sm:px-4 py-2 sm:py-2.5 border-b border-makoclaw-border/20 bg-makoclaw-surface/40 backdrop-blur-2xl z-20 gap-3 ring-1 ring-white/[0.03]">
        ...
        >
          <svg
            class="w-4 h-4 md:w-5 md:h-5 transition-transform duration-500"
        ...
        <div
          ...
          class="flex-1 flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-makoclaw-accent/15 to-transparent border border-makoclaw-accent/30 rounded-xl min-w-0"
        >
          <div class="w-5 h-5 rounded-lg bg-makoclaw-accent/20 flex items-center justify-center flex-shrink-0">
            <svg
              class="w-3 h-3 text-makoclaw-accent animate-spin"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div class="relative">
            ...
            <div class="relative glass-panel p-8 sm:p-10 rounded-2xl shadow-2xl shadow-makoclaw-accent/10 ring-1 ring-white/10">
              <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-2xl bg-gradient-to-br from-makoclaw-accent/20 to-purple-500/20 flex items-center justify-center ring-1 ring-white/20">
                <svg
                  class="w-8 h-8 sm:w-10 sm:h-10 text-makoclaw-accent animate-pulse"
