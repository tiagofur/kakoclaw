<template>
  <div class="flex flex-col h-full bg-makoclaw-bg relative overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute inset-0 opacity-25 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-500/30 via-transparent to-transparent" />
    ...
    <div class="glass-sticky top-0 z-20 border-b border-makoclaw-border/20">
      ...
      <div class="px-4 sm:px-6 pt-4 sm:pt-5 pb-3">
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-indigo-500/20 to-violet-500/20 flex items-center justify-center ring-1 ring-white/10 shadow-lg shadow-indigo-500/10">
            <svg
              class="w-5 h-5 sm:w-6 sm:h-6 text-indigo-400"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div class="flex-1 min-w-0">
            <h1 class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-makoclaw-text via-makoclaw-text to-indigo-400 bg-clip-text text-transparent">
              Files
            </h1>
      ...
      <div class="px-4 sm:px-6 pb-3 sm:pb-4">
        <div class="flex flex-col sm:flex-row gap-3">
          ...
          <div class="flex-1 relative group">
            <svg
              class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-makoclaw-text-secondary group-focus-within:text-indigo-400 transition-colors"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <p
          v-if="isSearching"
          class="text-xs text-indigo-400 mt-2 flex items-center gap-1.5"
        >
          <svg
        ...
        <p
          v-else-if="searchQuery && entries !== null"
          class="text-xs text-makoclaw-text-secondary mt-2"
        >
      ...
      <div class="px-4 sm:px-6 pb-3 flex items-center gap-1.5 text-sm overflow-x-auto scrollbar-hide">
        <button
          class="px-2 py-1 rounded-lg text-indigo-400 hover:bg-indigo-500/10 transition-all flex-shrink-0 font-medium"
          @click="navigateTo('')"
        >
          workspace
        </button>
        ...
        >
          <svg
            class="w-4 h-4 text-makoclaw-text-secondary/50 flex-shrink-0"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div class="bg-gradient-to-r from-indigo-500 to-violet-500 text-white px-6 py-4 rounded-2xl shadow-2xl animate-subtlePulse flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-white/70">
              Upload to /{{ currentPath || 'workspace' }}
            </p>
          </div>
        </div>
      </div>
        ...
        >
          ...
          >
            <div class="w-10 h-10 rounded-xl bg-makoclaw-surface/50 flex items-center justify-center group-hover:bg-indigo-500/10 transition-colors">
              <svg
                class="w-5 h-5 text-makoclaw-text-secondary group-hover:text-indigo-400 transition-colors"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <!-- Entry Content -->
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-0.5">
                    <span
                      v-if="!entry.is_dir"
                      class="text-xs text-makoclaw-text-secondary"
          ...
          >
            <div class="relative">
              <div class="absolute inset-0 bg-gradient-to-br from-indigo-500/30 to-violet-500/30 rounded-3xl blur-2xl opacity-50" />
        ...
        >
          <div class="glass-panel rounded-2xl overflow-hidden">
            ...
            <div class="p-4">
              <div
                v-if="fileError"
                class="text-amber-400 text-sm mb-4 p-3 bg-amber-500/10 rounded-lg border border-amber-500/20"
              >
                {{ fileError }}
              </div>
              <textarea
      ...
      >
        <div class="bg-makoclaw-surface/95 backdrop-blur-2xl border border-makoclaw-border/50 rounded-2xl w-full max-w-md shadow-2xl ring-1 ring-white/10 animate-scaleIn">
          ...
          <div class="p-4">
            ...
            <p
              v-if="deleteConfirmEntry.is_dir"
              class="text-xs text-amber-400 mt-3 p-2 bg-amber-500/10 rounded-lg border border-amber-500/20"
            >
