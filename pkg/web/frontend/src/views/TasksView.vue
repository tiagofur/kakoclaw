<template>
  <div class="flex flex-col h-full bg-makoclaw-bg relative overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute inset-0 opacity-25 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-blue-500/30 via-transparent to-transparent"></div>
      ...
      <div class="px-4 sm:px-6 pt-4 sm:pt-5 pb-3">
        <div class="flex items-center gap-3">
          ...
          <div class="flex-1 min-w-0">
            <h1 class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-makoclaw-text via-makoclaw-text to-blue-400 bg-clip-text text-transparent">Tasks</h1>
            <p class="text-xs sm:text-sm text-makoclaw-text-secondary mt-0.5">Kanban board for your projects</p>
          </div>
          <!-- Create task button -->
          <button
        ...
        <div class="flex flex-col gap-2 sm:gap-3">
          ...
          <div class="flex items-center gap-2 sm:gap-3">
            ...
            <div class="flex-1 relative group">
              <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-makoclaw-text-secondary group-focus-within:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Kanban Board -->
    <div class="flex-1 overflow-x-auto p-3 sm:p-4 md:p-6" style="scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch;">
