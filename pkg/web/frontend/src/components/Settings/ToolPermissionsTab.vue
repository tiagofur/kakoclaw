    ...
    <div class="glass-panel rounded-[2rem] p-8 md:p-10 border border-makoclaw-border/50 relative overflow-hidden group">
      ...
      <div class="relative z-10">
        ...
        <div v-if="loading" class="flex flex-col items-center justify-center py-24 gap-4">
          ...
          <p class="text-[10px] font-black uppercase tracking-widest text-makoclaw-text-secondary/50">Recalculating Permissions...</p>
        </div>
        ...
        <div v-else class="space-y-10">
          ...
          <div class="bg-blue-500/5 border border-blue-500/10 rounded-[1.5rem] p-6 flex items-start gap-4">
            ...
            <div>
              <p class="text-[11px] font-black uppercase tracking-widest text-makoclaw-text italic mb-2">Protocol Architecture</p>
              <ul class="space-y-2">
            ...
            <table class="w-full text-left text-sm border-collapse">
              <thead>
                <tr class="bg-makoclaw-bg/40 border-b border-makoclaw-border/50">
                  <th scope="col" class="px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] text-makoclaw-text-secondary/50">Intelligence Socket</th>
                  <th scope="col" class="px-6 py-5 text-center text-[10px] font-black uppercase tracking-[0.3em] text-makoclaw-text-secondary/50">Admins</th>
                  <th scope="col" class="px-6 py-5 text-center text-[10px] font-black uppercase tracking-[0.3em] text-makoclaw-text-secondary/50">Agents</th>
                  <th scope="col" class="px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] text-makoclaw-text-secondary/50 hidden md:table-cell">Function Definition</th>
                </tr>
              </thead>
              <tbody class="divide-y divide-makoclaw-border/30 text-makoclaw-text">
                <!-- Master Wildcard -->
                <tr class="bg-makoclaw-accent/[0.03] group/row">
                  <td class="px-8 py-4 font-black text-makoclaw-accent italic">
                  ...
                  <td class="px-8 py-4 text-[10px] font-bold text-makoclaw-text-secondary/40 uppercase tracking-widest hidden md:table-cell">Total Neural Integration</td>
                </tr>

                <!-- Restricted Exec -->
                <tr class="bg-amber-500/[0.03] group/row">
                  <td class="px-8 py-4 font-black text-amber-500 italic">
                    <span class="flex items-center gap-3">
                  ...
                  <td class="px-8 py-4 text-[10px] font-bold text-makoclaw-text-secondary/40 uppercase tracking-widest hidden md:table-cell">Sandboxed OS Interaction</td>
                </tr>
                ...
                <tr v-for="tool in availableTools" :key="tool.name" class="hover:bg-white/[0.02] transition-colors group/tool">
                  <td class="px-8 py-5">
                    <div class="flex items-center gap-3">
                      ...
                      <span v-if="isRestrictedTool(tool.name)" class="text-[8px] font-black uppercase text-orange-400 bg-orange-400/10 px-1.5 py-0.5 rounded shadow-[0_0_5px_rgba(251,146,60,0.2)]">Audited</span>
                    </div>
                  </td>
          ...
          <div class="glass-panel p-8 rounded-[2rem] bg-makoclaw-surface/30 border border-makoclaw-border/50">
             <div class="flex items-center gap-3 mb-8">
                <IconTerminal class="w-5 h-5 text-makoclaw-text-secondary/50" />
                <h4 class="text-[10px] font-black uppercase tracking-[0.3em] text-makoclaw-text-secondary/70">Restricted Paradigm Set</h4>
             </div>
