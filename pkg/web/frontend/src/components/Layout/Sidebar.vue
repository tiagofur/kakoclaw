    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <nav class="p-3 space-y-1">
        ...
        >
          ...
          <div v-if="uiStore.sidebarCollapsed" class="tooltip">
            Dashboard
          </div>
        </router-link>
        ...
        >
          <div class="relative flex-shrink-0">
            ...
            <span v-if="chatStore.isWorking" class="absolute -top-1 -right-1 flex h-2.5 w-2.5">
              <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-makoclaw-accent opacity-75"></span>
              <span class="relative inline-flex rounded-full h-2.5 w-2.5 bg-makoclaw-accent"></span>
            </span>
          </div>
          <span v-if="!uiStore.sidebarCollapsed" class="font-medium whitespace-nowrap text-sm flex items-center gap-2">
            Chat
            <span v-if="chatStore.isWorking" class="text-[10px] text-makoclaw-accent animate-pulse font-normal">working...</span>
          </span>
          <div v-if="uiStore.sidebarCollapsed" class="tooltip">
      ...
      <nav class="p-3 pt-0 space-y-1">
        <div v-if="!uiStore.sidebarCollapsed" class="px-3 py-2 text-[10px] font-bold uppercase tracking-[0.1em] text-makoclaw-text-secondary/50">Core Tools</div>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Skills</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Cron Jobs</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Files</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Knowledge</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">MCP Servers</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Workflows</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Agents</div>
      </router-link>
      </nav>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">History</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Memory</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Reports</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Metrics</div>
      </router-link>
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="tooltip">Settings</div>
      </router-link>
      </nav>
      ...
      >
        <svg v-if="uiStore.theme === 'dark'" class="w-5 h-5 flex-shrink-0 text-yellow-400 transition-transform duration-300" :class="{ 'rotate-180': uiStore.theme === 'dark' }" fill="currentColor" viewBox="0 0 20 20">
          <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
        </svg>
        <svg v-else class="w-5 h-5 flex-shrink-0 text-orange-400 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="relative">
        ...
        <!-- Profile Menu -->
        <div v-if="showProfileMenu" class="absolute bottom-full left-0 mb-2 w-full min-w-[12rem] bg-makoclaw-surface border border-makoclaw-border rounded-lg shadow-lg p-1 z-dropdown">
          <button
          ...
          <div class="h-px bg-makoclaw-border my-1"></div>
          <button
            @click="handleLogout"
