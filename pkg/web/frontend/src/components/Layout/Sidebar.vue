  ...
  >
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      >
        ...
        <div v-if="uiStore.sidebarCollapsed" class="absolute left-full ml-2 px-2 py-1 bg-makoclaw-accent text-white text-xs rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 whitespace-nowrap">
          Install App
        </div>
      </button>
      ...
      <div class="relative">
        ...
        <!-- Profile Menu -->
        <div v-if="showProfileMenu" class="absolute bottom-full left-0 mb-2 w-full min-w-[12rem] bg-makoclaw-surface border border-makoclaw-border rounded-lg shadow-lg p-1 z-50">
          <button
