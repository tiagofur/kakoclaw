  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        <button
          v-if="!archived"
          class="w-full text-left px-3 py-2 text-sm hover:bg-yellow-500/10 hover:text-yellow-500 transition-all flex items-center gap-2.5"
          @click="$emit('archive', taskId)"
        >
          <svg
            class="w-4 h-4 opacity-70"
            fill="none"
...
defineEmits(['close', 'edit', 'archive', 'delete'])
