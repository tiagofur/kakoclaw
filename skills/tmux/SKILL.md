...
when_to_use: When the user needs to send keystrokes to a running tmux session, read pane output, or automate an interactive CLI that cannot be driven non-interactively
